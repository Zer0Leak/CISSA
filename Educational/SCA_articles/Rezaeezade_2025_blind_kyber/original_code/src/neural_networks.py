...
def run_mlp(x_profiling, x_attack, y_profiling, actual_joint_train, actual_joint_test, epochs, classes, trained_folder,
    ...
    if dataset == "Kyber" or "Chipwhisperer":
        ...
        profile_total_acc, profile_detailed_acc_m1, profile_detailed_acc_m2, profile_detailed_acc_y = \
            customized_accuracy_ascon(predicted_hw_p, actual_joint_train)
        attack_total_acc, attack_detailed_acc_m1, attack_detailed_acc_m2, attack_detailed_acc_y = \
